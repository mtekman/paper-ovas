...
\changes{However, OVAS is accessed primarily through a graphical user-interface within a web browser which greatly facilitates the VCF file placement and configuration process by means of multiple file selection dialogues and forms to generate configuration profiles, as well as means to manage and view ongoing analyses as well as resultant interactive forms as shown in Figure~\ref{fig2}}.
