...
\textbf{Results:}\
\
Three case studies were analysed; 2 of autosomal recessive penetrance, and an X-linked dominant. \app made effective use of different module configurations to identify singular rare causative variants from whole-exome sequenced input samples.
\\
